...
| Was | Is |
|---|---|
| the author's own dataset directory | `local_paths.dataset_root()` |
| a HuggingFace cache directory | `local_paths.hf_hub()` (None-safe: the script says which key to set) |
